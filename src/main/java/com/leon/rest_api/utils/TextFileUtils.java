...
public class TextFileUtils {
    ...
    public static final List<String> ENCODINGS_TO_TRY = List.of(
            "utf-8", "utf-8-sig", "gbk", "gb2312", "big5", "cp950",
...
//            # ]
     ...
     */
    public static DecodingResult decodingVerification(String fileName, List<EncodingCandidate> encodingList) {
        ...
        for (EncodingCandidate encInfo : encodingList) {
            ...
            try {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(fileName), decoder))) {
                    String line;
        ...
        throw new IllegalArgumentException("No valid encoding found for file: " + fileName);
    }
}

...
public class UserAuthController implements UserAuthControllerInterface {
    ...
    @Override
    public ResponseEntity<CommonResponse<LoginResponseInterface>> login(@Valid @RequestBody LoginRequest request) {
        LoginResponseInterface loginResponse = userAuthService.login(request);
